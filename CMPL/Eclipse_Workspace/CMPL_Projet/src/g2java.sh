...
ANTLR_JAR=/home/paul/Documents/GitHub/L3/CMPL/Eclipse_Workspace/antlr-3.5.2-complete.jar
if [ ! -r $ANTLR_JAR ]
then
...
export CLASSPATH=/home/paul/Documents/GitHub/L3/CMPL/Eclipse_Workspace/antlr-3.5.2-complete.jar:.:$CLASSPATH
