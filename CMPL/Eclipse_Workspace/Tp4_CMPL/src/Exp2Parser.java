// $ANTLR 3.5.2 Exp2.g 2022-02-10 17:14:17
...
public class Exp2Parser extends Parser {
	...
	public final void terme() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_primaire_in_terme144);
			primaire();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,9,FOLLOW_9_in_terme158); 
		...
		try {
			...
			switch (alt3) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_nbentier_in_primaire202);
					nbentier();
					state._fsp--;
				...
				case 2 :
					// Exp2.g:47:5: ident
					{
					pushFollow(FOLLOW_ident_in_primaire210);
					ident();
					state._fsp--;
				...
				case 3 :
					// Exp2.g:48:5: '(' exp ')'
					{
					match(input,7,FOLLOW_7_in_primaire218); 
					pushFollow(FOLLOW_exp_in_primaire220);
					exp();
					state._fsp--;

					match(input,8,FOLLOW_8_in_primaire222); 
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// Exp2.g:56:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier241); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// Exp2.g:57:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident250); 
	...
	public static final BitSet FOLLOW_primaire_in_terme144 = new BitSet(new long[]{0x0000000000001202L});
	public static final BitSet FOLLOW_9_in_terme158 = new BitSet(new long[]{0x00000000000000B0L});
	...
	public static final BitSet FOLLOW_nbentier_in_primaire202 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire210 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_primaire218 = new BitSet(new long[]{0x00000000000000B0L});
	public static final BitSet FOLLOW_exp_in_primaire220 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_primaire222 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier241 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident250 = new BitSet(new long[]{0x0000000000000002L});
}
