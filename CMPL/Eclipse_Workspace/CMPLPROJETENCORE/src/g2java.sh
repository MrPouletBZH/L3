...
ANTLR_JAR=/d/GitHubProjects/L3/CMPL/Eclipse_Workspace/antlr-3.5.2-complete.jar
if [ ! -r $ANTLR_JAR ]
then
...
export CLASSPATH=/d/GitHubProjects/L3/CMPL/Eclipse_Workspace/antlr-3.5.2-complete.jar:.:$CLASSPATH
